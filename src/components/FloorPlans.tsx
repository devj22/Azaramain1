    ...
    <section id="floor-plans" className="py-20">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Floor Plans</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          <div className="p-4">
            <h3 className="text-2xl font-bold text-gray-800 mb-2">{floorPlans[activeTab].title}</h3>
            <p className="text-indigo-600 font-semibold mb-4">{floorPlans[activeTab].size}</p>
            
            <h4 className="text-lg font-semibold text-gray-700 mb-3">Features:</h4>
            ...
            <button className="mt-8 bg-indigo-600 hover:bg-indigo-700 text-white font-medium px-6 py-3 rounded-md transition-colors duration-300">
              Download Floor Plan
            </button>
          </div>
        </div>
