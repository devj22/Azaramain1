        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="font-bold text-xl">Luxe Living</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#highlights" className="text-gray-400 hover:text-white transition-colors duration-300">Project Highlights</a></li>
              <li><a href="#floor-plans" className="text-gray-400 hover:text-white transition-colors duration-300">Floor Plans</a></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span className="text-gray-400">123 Luxury Avenue, Downtown District, New York, NY 10001</span>
              </li>
              <li className="flex items-start">
                <span className="text-indigo-400 mr-2">•</span>
          ...
          <div>
            ...
            <form className="flex">
              <input
                ...
                className="px-4 py-2 bg-gray-800 text-white border border-gray-700 rounded-l-md focus:outline-none focus:ring-1 focus:ring-indigo-500 w-full"
              />
              <button
                type="submit"
